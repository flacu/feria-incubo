    ...
    $("#formularioForm").validate({
        ...
        submitHandler: function(a) {
            ...
            return "undefined" != typeof b && "" != b ? $.ajax({
                ...
                success: function(a) {
                    "OK" == a ? ($("#exito").addClass("active"), $("#formulario .titulo").css("display", "none"), 
                    $("#formularioForm").css("display", "none")) : ($("#error").addClass("active"), 
                    $("#formulario .titulo").css("display", "none"), $("#formularioForm").css("display", "none"));
                }
